...
const NAV_SECTIONS = [
  {
    ...
    items: [
      ...
      { id: "backup-security", label: "Backup & Security", icon: Shield },
    ],
  },
];
...
export default function MainControllerLayout({
  currentPage,
  onPageChange,
  onLogout,
  children,
      ...
      >
        <div className="flex items-center gap-3">
          <div
            ...
            style={{ background: "oklch(0.48 0.14 280)" }}
          >
        ...
        <div
          ...
          style={{
            background: "oklch(0.48 0.14 280 / 0.2)",
            ...
            <div className="space-y-0.5">
              {section.items.map(({ id, label, icon: Icon }) => (
                <button
                  key={id}
                  type="button"
                  data-ocid={`mc.${id.replace(/-/g, "_")}.link`}
                  onClick={() => {
                    onPageChange(id);
        ...
        >
          ...
          <div className="flex items-center gap-3">
            ...
            <span
              ...
              style={{
                background: "oklch(0.48 0.14 280 / 0.12)",
          ...
          {allNavItems.map(({ id, label, icon: Icon }) => (
            <button
              ...
              style={
                currentPage === id
                  ? {
                      background: "oklch(0.48 0.14 280 / 0.1)",
                      color: "oklch(0.48 0.14 280)",
                    }
                  : {}
              }
