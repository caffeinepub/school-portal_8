...
const navSections = [
  ...
  },
  {
    label: "Communication",
    items: [
      { id: "parent-messages", label: "Parent Messages", icon: MessageCircle },
    ],
  },
];
      ...
      <div className="px-4 py-5 border-b border-sidebar-border">
        ...
        {(teacherName ?? schoolName) && (
          <div
            ...
            style={{
              background: "oklch(var(--portal-teachers) / 0.18)",
              color: "oklch(var(--portal-teachers-light))",
            }}
          >
            {teacherName ?? schoolName}
          </div>
            ...
            <div className="space-y-0.5">
              {section.items.map(({ id, label, icon: Icon }) => (
                <button
                  key={id}
                  type="button"
                  data-ocid={`teacher.${id.replace(/-/g, "_")}.link`}
                  onClick={() => {
                    onPageChange(id);
        ...
        >
          ...
          <div className="flex items-center gap-2">
            ...
            <span
              ...
              style={{
                background: "oklch(var(--portal-teachers) / 0.1)",
                color: "oklch(var(--portal-teachers))",
              }}
            >
              Teachers Portal
            </span>
