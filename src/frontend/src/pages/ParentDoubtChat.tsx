...
function saveMessages(studentId: number, messages: DoubtMessage[]) {
  localStorage.setItem(`lords_doubts_${studentId}`, JSON.stringify(messages));
}

export default function ParentDoubtChat({ studentId, studentName }: Props) {
